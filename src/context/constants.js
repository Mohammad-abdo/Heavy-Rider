...
export const developedByLink = 'https://Qeema Tech.getappui.com/'
export const developedBy = 'Qeema Tech'
export const contactUs = 'Qeema Techstudio@gmail.com'
export const buyLink = ''
export const basePath = ''
export const DEFAULT_PAGE_TITLE = 'Heavy Ride | Responsive Admin Dashboard Template'
